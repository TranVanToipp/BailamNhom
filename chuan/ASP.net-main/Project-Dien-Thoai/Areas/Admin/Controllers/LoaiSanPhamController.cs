...
namespace Project_Dien_Thoai.Areas.Admin.Controllers
{
    public class LoaiSanPhamController : BaseController
    {
        ...
        public ActionResult Create([Bind(Include = "LoaiSP,TenLoaiSP")] LoaiSanPham loaiSanPham)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "LoaiSP,TenLoaiSP")] LoaiSanPham loaiSanPham)
        {
            if (ModelState.IsValid)
            {
